                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single-food-category cate-padding-1 text-center mb-30">
                        <div class="single-food-hover-2">
                            <img src="/web/img/category/<?= $category->img; ?>" alt="">
                        </div>
                ...
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="/web/img/product/card/<?= $pop_product->images[0]->image ?>" alt="">
                        </a>
                    ...
                    <div class="product-content">
                        <h4><a href="product-details.html"><?= $pop_product->name ?></a></h4>
                        <div class="product-price">
                            <span class="new">$<?= $pop_product->price ?>.00</span>
                            <span class="old">$<?= $pop_product->old_price ?>.00</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-10 ml-auto mr-auto">
                <div class="testimonial-wrap">
                    ...
                    <div class="testimonial-shap">
                        <img src="/web/img/icon-img/testi-shap.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30 gray-bg">
                        <div class="blog-img hover-effect">
                            <a href="/article/<?= $article->id; ?>"><img alt="" src="/web/img/blog/<?= $article->img; ?>"></a>
                        </div>
